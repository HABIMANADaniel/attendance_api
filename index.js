...
const port = 3006; // Adjust port number as needed

// Database credentials
const pool = mysql.createPool({
  host: 'b4hzh92tecjx3sbrkoko-mysql.services.clever-cloud.com',
  user: 'u8yyhte2gjqjktn4',
  password: 'sIaSPFfz2IVY2nI41nQl',
